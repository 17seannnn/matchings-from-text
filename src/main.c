               ...
               char **argv)
{
        ...
        */
        if (*file && !(*pattern)) {
                fputs("Error: Add -p param before patterns\n", stderr);
                *file = 0;
                return 0;
        }
        return 1;
